...
<div class="row tb">
    ...
    <div class="pull-right">
        <button id="app-daterange" type="button" class="btn btn-default dropdown-toggle daterange"
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th class="sortable" data-app-attr="pv">30天浏览量<#if field='pv'>&nbsp;<#if sort='desc'><span
                    class="caret-down"></span><#else><span
                    class="caret-up"></#if></#if></th>
            <th class="sortable" data-app-attr="order_num">订单数量<#if field='order_num'>&nbsp;<#if
            sort='desc'><span
                    class="caret-down"></span><#else><span
                    class="caret-up"></#if></#if></th>
        ...
        <#if isvAppPage.items?has_content>
            ...
            <tr>
                ...
                <td>${item.pv}</td>
                <td>${item.orderNum} (${(item.orderNum/item.pv*30)?string("0.##%")})</td>
                <td>${item.revenue}</td>
